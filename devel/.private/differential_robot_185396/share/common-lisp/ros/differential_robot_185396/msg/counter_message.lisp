...
(cl:in-package differential_robot_185396-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <counter_message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'counter_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name differential_robot_185396-msg:<counter_message> is deprecated: use differential_robot_185396-msg:counter_message instead.")))

(cl:ensure-generic-function 'count_left-val :lambda-list '(m))
(cl:defmethod count_left-val ((m <counter_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_robot_185396-msg:count_left-val is deprecated.  Use differential_robot_185396-msg:count_left instead.")
  (count_left m))

(cl:ensure-generic-function 'count_right-val :lambda-list '(m))
(cl:defmethod count_right-val ((m <counter_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader differential_robot_185396-msg:count_right-val is deprecated.  Use differential_robot_185396-msg:count_right instead.")
  (count_right m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<counter_message>)))
  ...
  "differential_robot_185396/counter_message")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'counter_message)))
  "Returns string type for a message object of type 'counter_message"
  "differential_robot_185396/counter_message")
